...
// A fixture archive (tests/fixtures/*.json.gz) may stand in for the seed: it is
// loaded in place of the thirty quiet years. TOWN=<name prefix> reads that
// town instead of the largest.
