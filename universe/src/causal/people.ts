...
export const LIFE_WORDS: Readonly<Record<string, string>> = {
  ...
  "herds-tamed": "Saw the wild beasts tamed and kept in herds",
  "herding-came": "Saw herding come to the land",
...
export const MEMORY_WORDS: Readonly<Record<string, string>> = {
  ...
  "herds-tamed": "the first herds being tamed",
  "herding-came": "herding coming to the land",
