...
const BRANCH_TECH_DEFS = Object.freeze([
  ...
  branchDef(
    ...
    "workshop",
    30,
    "blocks squared and coursed so a wall carries its own weight",
    { construction: 1.1 },
  ),
  branchDef(
    "matter",
    ...
    "forge",
    46,
    "two metals poured as one into a mould",
    { military: 1.1, construction: 1.05 },
  ),
  branchDef(
    "matter",
    2,
    ...
    "kiln",
    44,
    "sand and ash fused clear in a hot kiln",
    { research: 1.05, harvest: 1.03 },
  ),
  branchDef(
    "matter",
    2,
    ...
    "workshop",
    48,
    "rope over wheels lifting what no back could",
    { construction: 1.15 },
  ),
  branchDef(
    "matter",
    ...
    "workshop",
    40,
    "glass from the mountain's own fire knapped to an edge",
    { military: 1.08, research: 1.04 },
    seen("EruptionEvent"),
  ),
  branchDef(
    "matter",
    ...
    "forge",
    56,
    "ore reduced in a tall furnace to a harder metal",
    { military: 1.15, defense: 1.1 },
  ),
  branchDef(
    "matter",
    3,
    ...
    "hall",
    54,
    "stone that leans on stone to span a room",
    { resilience: 0.85, construction: 1.05 },
  ),
  branchDef(
    "matter",
    3,
    ...
    "dock",
    50,
    "woven cloth on a mast and a keel that holds a line",
    { naval: 1.3, urge: 0.03 },
  ),
  branchDef(
    "matter",
    ...
    "workshop",
    52,
    "a wheel turned by wind or stream to grind and pump",
    { harvest: 1.1, construction: 1.05 },
  ),
  branchDef(
    "matter",
    3,
    ...
    "workshop",
    50,
    "frames pinned to sway with the ground instead of against it",
    { resilience: 0.75 },
    seen("EarthquakeEvent"),
  ),
  branchDef(
    "matter",
    3,
    ...
    "forge",
    52,
    "metal worked from a stone that fell out of the sky",
    { military: 1.1, construction: 1.05 },
    seen("MeteorEvent"),
  ),
  branchDef(
    ...
    "gunpowder",
    "Black Powder",
    ["iron_smelting", "mathematics"],
    [C.SALT, C.FUEL],
    "forge",
    62,
    "a salt, a fuel, and a spark that throws stone",
    { military: 1.25 },
  ),
  branchDef(
    "matter",
    ...
    "steel",
    "Crucible Steel",
    ["iron_smelting", "kiln_glass"],
    [C.ORE, C.CATALYST],
    "forge",
    64,
    "iron held molten with a measure of carbon",
    { construction: 1.1, military: 1.15, resilience: 0.9 },
  ),
  branchDef(
    "matter",
    4,
    "concrete",
    "Poured Concrete",
    ["arch_vault", "chemistry"],
    [C.MINERAL, C.SOLVENT],
    "workshop",
    66,
    "ground stone that sets hard in any shape",
    { construction: 1.2, resilience: 0.8 },
  ),
  branchDef(
    "matter",
    4,
    "steam_power",
    "Steam Power",
    ["mechanization", "windmills"],
    [C.METAL, C.FUEL],
    "forge",
    64,
    "water boiled to drive a piston",
    { factory: 1.25, construction: 1.1 },
  ),
  branchDef(
    "matter",
    5,
    "ballistics",
    "Ballistics",
    ["gunpowder", "mathematics"],
    [C.METAL, C.INFO],
    "archive",
    68,
    "the arc of a shot worked out before it is fired",
    { military: 1.2 },
  ),
  branchDef(
    "matter",
    ...
    "factory",
    72,
    "a skeleton of steel that walls merely clothe",
    { construction: 1.2, resilience: 0.9 },
  ),
  branchDef(
    "matter",
    5,
    ...
    "factory",
    74,
    "current carried on wires to every door",
    { factory: 1.3, research: 1.05 },
  ),
  branchDef(
    "matter",
    5,
    ...
    "factory",
    74,
    "fuel cracked into a hundred useful things",
    { factory: 1.2, harvest: 1.05 },
  ),
  branchDef(
    "matter",
    6,
    "aeronautics",
    "Aeronautics",
    ["combustion", "ballistics"],
    [C.METAL, C.FUEL],
    "factory",
    80,
    "a wing that carries an engine through the air",
    { military: 1.2, urge: 0.05 },
  ),
  branchDef(
    "matter",
    6,
    "fission_power",
    "Fission Power",
    ["power_grid", "computing"],
    [C.ORE, C.CATALYST],
    "factory",
    86,
    "heavy nuclei split for heat and current",
    { factory: 1.4, construction: 1.05 },
  ),
  branchDef(
    "matter",
    6,
    "composites",
    "Advanced Composites",
    ["petrochemistry", "steel_frame"],
    [C.FIBER, C.CATALYST],
    "factory",
    84,
    "fibres bound in resin, lighter than metal and as strong",
    { construction: 1.15, naval: 1.2 },
  ),
  // ── Life ────────────────────────────────────────────────────────────────────
  branchDef(
    "life",
    ...
    "hearth",
    28,
    "which leaf soothes and which root purges, remembered",
    { hygiene: 0.9, longevity: 1.03 },
  ),
  branchDef(
    "life",
    1,
    ...
    "corral",
    34,
    "herds kept and bred instead of hunted",
    { harvest: 1.1, fertility: 1.05 },
  ),
  branchDef(
    "life",
    2,
    ...
    "Crop Rotation",
    ["agriculture", "storage"],
    [C.NUTRIENT, C.ORGANIC],
    "farm",
    40,
    "fields rested and changed so the soil gives again",
    { harvest: 1.15 },
  ),
  branchDef(
    "life",
    ...
    "clinic",
    42,
    "practised hands at every birth",
    { fertility: 1.1, longevity: 1.03 },
  ),
  branchDef(
    "life",
    2,
    ...
    "kiln",
    40,
    "grain fermented into a drink that keeps",
    { unrest: 0.03, hygiene: 0.95 },
  ),
  branchDef(
    "life",
    3,
    ...
    "farm",
    52,
    "the best of each generation chosen to seed the next",
    { harvest: 1.15 },
  ),
  branchDef(
    "life",
    ...
    "clinic",
    50,
    "the sick kept apart until the sickness passes",
    { hygiene: 0.7 },
  ),
  branchDef(
    "life",
    ...
    "Anatomy",
    ["medicine", "writing"],
    [C.MEDICINE, C.PIGMENT],
    "clinic",
    54,
    "the body opened, drawn, and understood",
    { longevity: 1.05, hygiene: 0.9 },
  ),
  branchDef(
    "life",
    4,
    "surgery",
    "Surgery",
    ["anatomy", "bronze_casting"],
    [C.METAL, C.MEDICINE],
    "clinic",
    60,
    "the knife used to mend what it once only wounded",
    { longevity: 1.06, military: 1.05 },
  ),
  branchDef(
    "life",
    4,
    "fertilizer",
    "Mineral Fertilizer",
    ["chemistry", "crop_rotation"],
    [C.SALT, C.NUTRIENT],
    "workshop",
    62,
    "the salts a field lacks, made and spread",
    { harvest: 1.2 },
  ),
  branchDef(
    "life",
    ...
    "vaccination",
    "Vaccination",
    ["germ_theory", "quarantine"],
    [C.MEDICINE, C.CATALYST],
    "clinic",
    66,
    "a small sickness given to forestall a great one",
    { hygiene: 0.6, longevity: 1.05 },
  ),
  branchDef(
    "life",
    5,
    ...
    "factory",
    70,
    "a made cold that keeps food through any season",
    { harvest: 1.1, unrest: 0.02 },
  ),
  branchDef(
    "life",
    5,
    "antibiotics",
    "Antibiotics",
    ["vaccination", "chemistry"],
    [C.MEDICINE, C.CATALYST],
    "clinic",
    72,
    "a mould's own poison turned against the pathogens",
    { hygiene: 0.6, longevity: 1.08 },
  ),
  branchDef(
    "life",
    5,
    "genetics",
    "Genetics",
    ["selective_breeding", "optics", "printing"],
    [C.INFO, C.MEDICINE],
    "archive",
    76,
    "the thread of inheritance read letter by letter",
    { harvest: 1.15, fertility: 1.05 },
  ),
  branchDef(
    "life",
    5,
    "ecology",
    "Ecology",
    ["selective_breeding", "mathematics"],
    [C.ORGANIC, C.INFO],
    "observatory",
    70,
    "the web of living things counted and its knots found",
    { resilience: 0.9, harvest: 1.05 },
  ),
  branchDef(
    "life",
    6,
    "hydroponics",
    "Hydroponics",
    ["fertilizer", "power_grid"],
    [C.NUTRIENT, C.SOLVENT],
    "factory",
    80,
    "crops raised in water under a made light",
    { harvest: 1.25 },
  ),
  branchDef(
    "life",
    ...
    "clinic",
    86,
    "the thread of inheritance mended where it frays",
    { longevity: 1.12, fertility: 1.05 },
  ),
  // ── Mind ────────────────────────────────────────────────────────────────────
  branchDef(
    "mind",
    ...
    "hearth",
    26,
    "the long tale told the same way every winter",
    { research: 1.05, unrest: 0.02 },
  ),
  branchDef(
    "mind",
    1,
    ...
    "shrine",
    34,
    "the year marked in stones and feasts so sowing is never late",
    { harvest: 1.05, unrest: 0.02 },
  ),
  branchDef(
    "mind",
    2,
    ...
    "market",
    44,
    "one bushel and one span agreed by all",
    { taxes: 1, barter: 1.1 },
  ),
  branchDef(
    "mind",
    ...
    "philosophy",
    "Philosophy",
    ["writing", "oral_tradition"],
    [C.INFO, C.PIGMENT],
    "archive",
    46,
    "the habit of asking why, written down",
    { research: 1.1, unrest: 0.02 },
  ),
  branchDef(
    "mind",
    2,
    "theatre",
    "Theatre",
    ["ritual_calendar", "writing"],
    [C.PIGMENT, C.FIBER],
    "hall",
    44,
    "the town's own story played back to it",
    { unrest: 0.04 },
  ),
  branchDef(
    "mind",
    ...
    "hall",
    52,
    "every household counted and its due recorded",
    { taxes: 2, urge: 0.02 },
  ),
  branchDef(
    "mind",
    ...
    "hall",
    54,
    "law reasoned from principle instead of remembered from custom",
    { unrest: 0.04, opinion: 4 },
  ),
  branchDef(
    "mind",
    3,
    ...
    "archive",
    50,
    "the known world drawn to scale",
    { urge: 0.05, naval: 1.1 },
  ),
  branchDef(
    "mind",
    ...
    "banking",
    "Banking",
    ["currency", "weights_measures"],
    [C.METAL, C.INFO],
    "market",
    60,
    "coin lent against a promise written down",
    { taxes: 3, barter: 1.1 },
  ),
  branchDef(
    "mind",
    ...
    "archive",
    62,
    "scholars gathered to teach and to argue",
    { research: 1.2 },
  ),
  branchDef(
    "mind",
    ...
    "diplomatic_corps",
    "Diplomatic Corps",
    ["jurisprudence", "cartography"],
    [C.INFO, C.PIGMENT],
    "hall",
    58,
    "envoys trained to speak for the polity abroad",
    { opinion: 8 },
  ),
  branchDef(
    "mind",
    ...
    "archive",
    66,
    "a claim tested against the world before it is believed",
    { research: 1.25 },
  ),
  branchDef(
    "mind",
    ...
    "hall",
    68,
    "offices filled by examination and kept between rulers",
    { unrest: 0.05, taxes: 3 },
  ),
  branchDef(
    "mind",
    ...
    "archive",
    70,
    "one voice heard in every house at once",
    { unrest: 0.03, research: 1.05 },
  ),
  branchDef(
    "mind",
    5,
    "economics",
    "Economics",
    ["banking", "scientific_method"],
    [C.INFO, C.METAL],
    "market",
    70,
    "the flow of coin and grain understood as a whole",
    { taxes: 4, barter: 1.15 },
  ),
  branchDef(
    "mind",
    ...
    "sociology",
    "Sociology",
    ["census", "scientific_method"],
    [C.INFO, C.PIGMENT],
    "archive",
    72,
    "the town studied as a living thing",
    { unrest: 0.05, opinion: 3 },
  ),
  branchDef(
    "mind",
    6,
    "global_networks",
    "Global Networks",
    ["computing", "mass_media"],
    [C.CRYSTAL, C.INFO],
    "office",
    84,
    "every archive joined to every other",
    { research: 1.15, opinion: 5 },
  ),
  branchDef(
    "mind",
    6,
    "artificial_minds",
    "Thinking Machines",
    ["global_networks", "scientific_method"],
    [C.CRYSTAL, C.INFO],
    "office",
    90,
    "a machine that reasons on the record without tiring",
    { research: 1.3, construction: 1.1 },
  ),
]);
...
const BRANCH_FRONTIER = Object.freeze({
  matter: {
    ...
    process: "the frontier of what matter can be made to do",
    effects: { construction: 1.05, military: 1.05 },
  },
  life: {
    name: "Biosciences",
    prior: "gene_therapy",
    materials: [C.MEDICINE, C.CRYSTAL],
    process: "the frontier of what a body can be helped to do",
    effects: { longevity: 1.03, harvest: 1.05 },
  },
  mind: {
    name: "Deep Theory",
    prior: "artificial_minds",
    materials: [C.INFO, C.CRYSTAL],
    process: "the frontier of what can be known",
    effects: { research: 1.05, unrest: 0.01 },
  },
});
    ...
    for (let n = 1; n <= BRANCH_FRONTIER_TIERS; n++)
      out.push(
        branchDef(
          branch,
          7,
          `frontier_${branch}_${n}`,
          `${f.name} ${ROMAN[n - 1]}`,
          [n === 1 ? f.prior : `frontier_${branch}_${n - 1}`],
          f.materials,
          "office",
          96 + 12 * n,
          f.process,
...
for (const def of BRANCH_ALL_DEFS)
...
function branchEffects(place) {
  ...
  if (!cached || cached.world !== W || cached.signature !== signature) {
    ...
    for (const id of known) {
      ...
      if (!e) continue;
      for (const k in e)
        if (BRANCH_ADDITIVE.includes(k)) f[k] += e[k];
        else f[k] *= e[k];
    }
...
constructionTempoFactor = function (place) {
  return Math.min(
    2.8,
    constructionTempoFactorBranchBase(place) * branchEffects(place).construction,
  );
};
...
damageBuiltPlace = function (
  ...
  const softened =
    amount > 0 ? Math.max(1, Math.round(amount * branchEffects(place).resilience)) : amount;
...
fertilityFactor = function (id, other) {
  return clamp(
    fertilityFactorBranchBase(id, other) * branchEffects(homeSettlementOf(id)).fertility,
    0.2,
    1.5,
  );
};
...
naturalLifespan = function (id, body) {
  return (
    naturalLifespanBranchBase(id, body) *
    Math.min(1.4, branchEffects(homeSettlementOf(id)).longevity)
  );
};
...
collectTaxes = function (f) {
  ...
  let extra = 0;
  for (const s of W.settlements)
    if (!s.ruined && s.factionId === f.id) extra += branchEffects(s).taxes;
...
opinionTarget = function (a, b) {
  const r = opinionTargetBranchBase(a, b),
    warmth = Math.round(
      factionBranchEffect(a?.id, "opinion") + factionBranchEffect(b?.id, "opinion"),
    );
  if (!warmth || !r?.reasons) return r;
  r.reasons.push({ label: "envoys and letters", value: warmth });
  r.target = clamp(
    r.reasons.reduce((n, x) => n + x.value, 0),
    -100,
    100,
  );
  ...
  const e = f?.ethos || {},
    ...
    pref = {
      ...
      life:
        0.85 +
        (1 - expansionist) * 0.25 +
        Math.max(0, openness) * 0.2 +
        (inventive < 0.4 ? 0.1 : 0),
      mind: 0.85 + inventive * 0.4 + mercantile * 0.15,
    };
  if (place) {
    const counts = {
        matter: branchKnownCount(place, "matter"),
        life: branchKnownCount(place, "life"),
        mind: branchKnownCount(place, "mind"),
      },
      least = Math.min(counts.matter, counts.life, counts.mind);
    for (const k in pref)
      pref[k] += 0.06 * Math.min(3, counts[k] - least) * -1 + (counts[k] === least ? 0.08 : 0);
    if (typeof settlementFood === "function" && settlementFood(place) < BRANCH_HUNGER_FOOD)
      pref.life += BRANCH_HUNGER_PULL;
  }
  return pref;
}
...
chooseResearchFocus = function (s, eligible) {
  ...
  const f = W.factions.find((x) => x.id === s.factionId),
    ...
    ranked = eligible
      .slice()
      .sort((a, b) => score(b) - score(a) || (a.tech.id < b.tech.id ? -1 : 1));
    ...
    for (const branch of Object.keys(BRANCHES)) {
      ...
      for (const rung of [3, 6])
        if (tier >= rung)
          recordMilestone(
            `branch-${branch}-${rung}`,
            `${s.name} mastered the ${BRANCHES[branch]} branch to the ${rung === 3 ? "third" : "sixth"} tier`,
            s,
            {
...
renderTechnologyPage = function () {
  const html = renderTechnologyPageBranchBase(),
    ...
    sections = Object.keys(BRANCHES)
      .map((branch) => {
        const defs = BRANCH_ALL_DEFS.filter((d) => d.branch === branch),
          ...
          lead = towns
            .slice()
            .sort(
              (a, b) => branchKnownCount(b, branch) - branchKnownCount(a, branch) || a.id - b.id,
            )[0],
          rows = defs
            .map((d) => {
              const n = techKnownCount(d.id),
                ...
                note = n
                  ? ""
                  : ` <span class="muted">${researching ? `${researching} at work` : d.rare ? "rare · needs the thing seen" : `tier ${d.tier}`}</span>`;
      ...
      .join("");
  return `${html}<div class="subhead">The three branches</div><div class="muted">Beyond the spine of the tree, three branches: ${Object.keys(
    BRANCHES,
  )
...
window.ALIFE_BRANCHES_DEBUG = Object.freeze({
  ...
  preference: (factionId, placeId = 0) =>
    branchPreference(
      W.factions.find((f) => f.id === factionId),
      W.settlements.find((s) => s.id === placeId) || null,
    ),
  tier: (placeId, branch) =>
    branchTier(
  ...
  provisionAllowed: (placeId, techId) =>
    branchProvisionAllowed(
      W.settlements.find((s) => s.id === placeId),
      BRANCH_BY_ID.get(techId) || { id: techId },
    ),
