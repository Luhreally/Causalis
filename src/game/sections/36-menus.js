...
function showPauseMenu() {
  ...
  // The same question the R key asks: a regenerated world replaces this history.
  $("#pauseRegen").onclick = confirmRegenerateCurrent;
